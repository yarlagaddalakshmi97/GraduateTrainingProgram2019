...
Click the ChinookDatabase.Sqlite download button from the [Chinook Database](https://www.nuget.org/packages?q=chinook) site. Know which directory that it's being downloaded to.
