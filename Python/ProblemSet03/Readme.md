...
1. Write a function called rotate_word() that takes a string and an integer as parameters, and that
...
1. In 1939 Ernest Vincent Wright published a 50,000 word novel called Gadsby that
...
1. Modify the above program to print only the words that have no “e” and compute the percentage of the words in the list have no “e.”

1. Write a function named avoids that takes a word and a string of forbidden letters,
and that returns True if the word doesn’t use any of the forbidden letters.

1. Modify your program to prompt the user to enter a string of forbidden letters and then print the
number of words that don’t contain any of them. Can you find a combination of 5 forbidden letters
that excludes the smallest number of words?

1. Write a function named using_only() that takes a word and a string of letters, and
...
1. Write a function called is_abecedarian that returns True if the letters in a word
...
1. Two words are anagrams if you can rearrange the letters from one to spell the other.
